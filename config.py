...
to_show_pages =[
        ...
        Page("pages/coach_AngenehmeAktivitätengestalten.py", "Angenehme Aktivitaeten gestalten"),
        ...
        Page("pages/coach_KörperpflegeundToilette.py", "Koerperpflege und Toilette"),
        ...
        Page("pages/coach_AbklärungundDiagnose.py", "Abklaerung und Diagnose"),
        ...
        Page("pages/coach_SchwierigeGesprächssituationen.py", "Schwierige Gespraechssituationen"),
        ...
        Page("pages/coach_Sichverständigen.py", "Sich verstaendigen"),
        Page("pages/coach_UnterstützungfürAngehörige.py", "Unterstuetzung fuer Angehoerige"),
